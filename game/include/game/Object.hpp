...
namespace RUNBOXRUN
{
	...
	class Object
	{
		...
		Object(const double &speed, const glm::vec3 &position, const glm::vec3 &size, const glm::vec3 &color, const std::string &pathObj);/*!< object's constructor with arguments*/
