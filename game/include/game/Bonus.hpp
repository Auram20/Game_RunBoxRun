...
namespace RUNBOXRUN
{
	...
	class Bonus: public EventObject
	{
		...
		Bonus(const double &speed, const glm::vec3 &position, const glm::vec3 &size, const glm::vec3 &color, const unsigned int &value, const Model &model); /*!< bonus's constructor with parameters*/
